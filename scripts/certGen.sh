...
openssl x509 -req -in backdoor.aws.araalinetworks.com.csr -CA rootCA.crt -CAkey rootCA.key -CAcreateserial -days 365 -out backdoor.aws.araalinetworks.com.crt
